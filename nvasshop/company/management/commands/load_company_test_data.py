...
def add_test_data():
    ...
    company2 = Company.objects.create(name='Precision Diagnostics', address='456 Lab Street', description='Specializing in advanced diagnostic equipment.', email='info@precisiondiagnostics.com', website='www.precisiondiagnostics.com', rate=3.8, start_time=time(8, 0, 0), end_time=time(16, 0, 0))
    company3 = Company.objects.create(name='Surgical Innovations Ltd.', address='789 Surgeon Lane', description='Innovative solutions for surgical procedures.', email='info@surgicalinnovations.com', website='www.surgicalinnovations.com', rate=4.2, start_time=time(8, 0, 0), end_time=time(16, 0, 0))
    company4 = Company.objects.create(name='Health Tech Innovations', address='456 Health Innovation Street', description='Revolutionizing the health tech industry', email='info@healthtechinnovations.com', website='www.healthtechinnovations.com', rate=4.7, start_time=time(8, 0, 0), end_time=time(16, 0, 0))
    company5 = Company.objects.create(name='Global Health Services Co', address='789 Health Service Avenue', description='Providing global health solutions', email='info@globalhealthservicesco.com', website='www.globalhealthservicesco.com', rate=3.5, start_time=time(8, 0, 0), end_time=time(16, 0, 0))
    company6 = Company.objects.create(name='Healthcare Solutions Ltd', address='123 Health Street', description='Leading the way in healthcare technology', email='info@healthcaresolutions.com', website='www.healthcaresolutions.com', rate=4.0, start_time=time(8, 0, 0), end_time=time(16, 0, 0))
